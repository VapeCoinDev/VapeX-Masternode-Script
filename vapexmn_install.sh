...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='vapexcoin.conf'
CONFIGFOLDER='/root/.vapexcoin'
COIN_DAEMON='vapexcoind'
COIN_CLI='vapexcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/VapeCoinDev/VAPEX/releases/download/V1.0/Vapex-Linux-wallets.tar.gz'
...
function important_information() {
 ...
 echo -e "If you enjoyed this quick and easy way to set up your MN, please feel free to donate to the Dev - BTC: 3Mi9fUVroHYSds6Dsu66eGtsP2EVba8Mm3 ETH: 0x94E27a1DF0fbc3E694c8B995EBF7F75277cAe7fd"
